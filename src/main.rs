...
/*
    Fix: handle Index out of bounds: the len is 1 but the index is 1 in line 142 when handling TCP protocol
    Fix: Better File Handling , since when there is no file i am still getting an error
    TODO: Things to add  ->:
...
fn get_html_for_dir(dir: std::fs::ReadDir,abs_path : &str) -> String {
